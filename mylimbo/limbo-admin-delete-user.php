	...
	<div class="main"> <!--main is where all the text and stuff goes... the main part of the page-->
		...
		<?php
			...
			if($_SERVER['REQUEST_METHOD'] == 'GET'){
				if(isset($_GET['id'])){
					delete_record_user($dbc, $_GET['id']);
					...
					#The following is basically just the load function from the login tools
					  ...
					  $url = rtrim( $url, '/\\' ) ;
					  $url .= '/limbo-admin-table-user.php';
				...
				echo '<h1>An error has occurred. Please go back to the <a href="limbo-admin-table-user.php">table</a> and select a user.</h1>';
